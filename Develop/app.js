...
function start() {
  ...
  const questions = [
    // provide validation for the employee name, id and email responses
    {
      type: "input",
    ...
    // require the ID number to have 4 digits
    {
      type: "input",
      message: "Please enter the 4-digit employee ID number",
      name: "id",
      validate: answer => {
        if (answer.length !== 4) {
